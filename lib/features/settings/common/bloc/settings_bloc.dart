...
class SettingsAddRfidToken extends SettingsEvent {
  ...
  const SettingsAddRfidToken(this.token);
...
class SettingsRemoveRfidToken extends SettingsEvent {
  ...
  const SettingsRemoveRfidToken(this.tokenHash);
...
class SettingsOperationSuccess extends SettingsState {
  ...
  const SettingsOperationSuccess({required this.message, required this.config});
...
class SettingsBloc extends Bloc<SettingsEvent, SettingsState> {
  ...
  Future<void> _onRemoveRfidToken(
    ...
    try {
      await _repository.removeRfidToken(event.tokenHash);
      emit(
